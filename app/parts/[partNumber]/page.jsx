...
export default function PartDetailPage({ params }) {
  ...
  //     description:
  //       language === "english"
  //         ? "Part content copied to clipboard"
  //         : "भागको सामग्री क्लिपबोर्डमा प्रतिलिपि गरियो",
  //   });
  // };

  // const speakPartText = () => {
  //   if (!part) return;
  //   const text = `${part.title}. ${part.articles
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                {language === "english" ? "Articles" : "धाराहरू"}
              </p>
            </div>
            ...
            {part.articles.map((article, index) => (
              ...
              >
                <Card
                  ...
                  onClick={() =>
                    router.push(`/parts/${part.partNumber}/articles/${index}`)
                  }
                >
